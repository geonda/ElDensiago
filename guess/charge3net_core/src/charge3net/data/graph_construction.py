...
class GraphConstructor(object):
    ...
    def probes_to_graph(self,atoms, probe_pos, neighborlist=None, inv_cell_T=None):
        kdtree=KdTreeGraphConstructor(cutoff=self.cutoff)
        return kdtree.probes_to_graph(atoms, probe_pos, neighborlist=None, inv_cell_T=None)
...
class KdTreeGraphConstructor(GraphConstructor):
    ...
    def probes_to_graph(self, atoms, probe_pos, neighborlist=None, inv_cell_T=None):
        ...
        # print(probe_edges, probe_edges_displacement)
