...
from guess.charge3net_core.src.charge3net.data.split import split_data
import guess.charge3net_core.src.utils.data as utils
...
class DensityPickleDir(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        density, atoms = utils._load_numpy_density(root=self.root)
